    ...
    <form action={formAction} className="mt-2 space-y-2">
      ...
      <div className="flex gap-2">
        <button
          ...
          name="decision"
          value="APPROVED"
          className="rounded-lg bg-emerald-600 px-3 py-1.5 text-[17px] font-medium text-white hover:bg-emerald-700"
        >
          Approve
        </button>
        <button
          ...
          name="decision"
          value="REJECTED"
          className="rounded-lg bg-red-600 px-3 py-1.5 text-[17px] font-medium text-white hover:bg-red-700"
        >
          Reject
        </button>
      </div>
